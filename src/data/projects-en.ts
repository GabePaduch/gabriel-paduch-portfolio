...
export const projectsEn: Project[] = [
  ...
  {
    id: '3',
    title: 'API Instances Platform',
    description: 'Management of multiple API instances for clients using Docker, PostgreSQL and token authentication.',
  ...
  },
  {
    ...
    description: 'AI project for product search by visual similarity using Milvus and OpenCV.',
  ...
  },
  {
    ...
    description: 'Automated WhatsApp flows integrated with Dify and PostgreSQL for business automation.',
